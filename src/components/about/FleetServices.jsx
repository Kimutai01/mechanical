        ...
        <div className="flex flex-col   p-5 md:p-0 mt-10">
          <div className="mt-10 ">
            ...
            {activeParagraphIndex === 0 && (
              <p className="text-[grey]">
                ...
                malfunctions. Depending on what the issue is, it could be fixed
                in a day or take over 1 week for a major job. Once we diagnose
                your car, we will be able to give you a better estimate for how
          ...
          <div className="border-t-[1px] border-[grey] mt-7">
            <div className="mt-7 ">
              ...
              {activeParagraphIndex === 1 && (
                <p className="text-[grey]">
                  It is highly recommended that you make an appointment. We are
                  an independent auto repair center and we pride ourselves on
                  our quality work and stellar reviews. We might be completely
                  booked and not be able to get to your car right away. For that
                  reason, we recommend making an appointment or calling ahead.
                </p>
              )}
            </div>
          </div>
